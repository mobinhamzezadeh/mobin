...
@section('content')
    ...
    <ul class="breadcrumb bg-white mt-4">
        ...
        <li class="breadcrumb-item"><a href="{{route('site.contact')}}" class="pr-2 font-12 vazir">تماس با ما</a></li>
    </ul>
</div>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-12 mb-3 d-flex justify-content-center align-items-center">
            <h5 class="title pb-2 ">{{$contact->title}}</h5>
        </div>
    </div>
</div>
...
<div class="container py-4">
    <div class="row">
        <div class="col-sm-4 text-center info">
            ...
            <p class="mt-3 font-14">{{$contact->phone}}</p>
        </div>

        <div class="col-sm-4 text-center info">
            <i class="fas fa-envelope"></i>
            <p class="mt-3 font-14">{{$contact->email}}</p>
        </div>

        <div class="col-sm-4 text-center info">
            <i class="fas fa-map-marker-alt"></i>
            <p class="mt-3 font-14" >{{$contact->address}}</p>
        </div>
    </div>
</div>
...
{{--        <div class="col-md-6 contact bg-white py-3 shadow-sm mb-3">--}}
{{--            <h6 class="text-info mr-2">ارتباط با ما</h6>--}}
{{--            <p class="text-justify vazir font-14 contact">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده--}}
...
{{--                    <textarea  cols="30" rows="10" class="form-control w-100 rounded-lg p-3" placeholder="پیام خود را وارد کنید ..."></textarea>--}}
{{--                </div>--}}
